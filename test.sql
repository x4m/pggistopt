...
insert into queries(id,l1,l2,l3) select s,random()/1.2,random()/1.2,random()/1.2 from generate_series(1,1e2,1) s;
update queries set q = cube(array[l1,l2,l3],array[l1+0.10001,l2+0.10001,l3+0.10001]);
